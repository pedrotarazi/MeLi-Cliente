...
class AgencyController {
    ...
    def save(Agency agency) {
        ...
        try {
            if (agencyService.get(agency.id) == null){
                agencyService.save(agency)
            }
            else{
                respond "Ya es una agencia recomendada"
            }
    ...
    def delete(Long id) {
        ...
        if (agencyService.get(id) != null){
            agencyService.delete(id)
            respond "Ya no es una agencia recomendada"
        }
        else{
            respond "Nunca fue una agencia recomendad"
        }
